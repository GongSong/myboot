...
import com.yh.kuangjia.util.Wx.WXPayConstants.SignType;
...
public class WXPay {
    ...
    public Map<String, String> Signature(Map<String, String> reqData) throws Exception {
        reqData.put("nonce_str", WXPayUtil.generateNonceStr());
        if (SignType.MD5.equals(this.signType)) {
            reqData.put("sign_type", WXPayConstants.MD5);
        }
     ...
     * @throws Exception
     */
    public Map<String, String> withdrawal(Map<String, String> reqData) throws Exception {
        return this.withdrawal(reqData, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    }
    /**
     * 作用：提现<br>
     * 场景：
     ...
     * @throws Exception
     */
    public Map<String, String> withdrawal(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WXPayConstants.SANDBOX_PROMOTION_TRANSFERS;
        }
        else {
            url = WXPayConstants.PROMOTION_TRANSFERS;
        }
     ...
     * @throws Exception
     */
    public Map<String, String> getPublicKey(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WXPayConstants.SANDBOX_GET_PUBLIC_KEY;
        }
        else {
            url = WXPayConstants.GET_PUBLIC_KEY;
        }
        String respXml = this.requestWithCert(url,reqData, connectTimeoutMs, readTimeoutMs);
